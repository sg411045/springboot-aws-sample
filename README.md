# springboot-aws-sample serverless API
The springboot-aws-sample project, created with [`aws-serverless-java-container`](https://github.com/awslabs/aws-serverless-java-container).
    ...
    "Stacks": [
        {
            ...
            "Description": "AWS Serverless Spring API - my.service::springboot-aws-sample", 
            "Tags": [], 
            "Outputs": [
                {
                    "Description": "URL for application",
                    "ExportName": "SpringbootAwsSampleApi",  
                    "OutputKey": "SpringbootAwsSampleApi",
